...
public class SA19_handleDropdwonWithSelectClass extends baseFunction {
	...
	public static void main(String[] args) {
		...
		// all operations can be performed vis countryDowndown only.
		...
		System.out.println("Total no. of options size in dd " + allDDOptions.size());
		...
		countryDropdown.selectByValue("83");// it always be in string datatype. //Ghana
